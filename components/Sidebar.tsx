...
import { LayoutDashboard, BarChart3, Search, AlertCircle, RefreshCw, Download } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, onReset, onExport }) => {
  const menuItems = [
