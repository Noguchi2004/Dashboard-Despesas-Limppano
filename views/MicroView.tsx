...
const MicroView: React.FC<MicroViewProps> = ({ data, selectedYear, compareYear, selectedMonths }) => {
  ...
  // Total Listed is sum of what's in the table
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-slate-800 border border-slate-700 p-4 rounded-xl flex items-center justify-between">
                <div>
                    <p className="text-slate-400 text-xs font-bold uppercase">Total Listado</p>
                    <p className="text-xl font-bold text-white mt-1">{formatCompactCurrency(totalListed)}</p>
                </div>
