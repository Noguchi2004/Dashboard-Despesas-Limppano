...
const AiAssistantView: React.FC<AiAssistantViewProps> = ({ data }) => {
  ...
  const handleSend = async () => {
    ...
    try {
      // Fixed: Initialize GoogleGenAI with named parameter as per guidelines
      ...
      // Fixed: Using gemini-3-pro-preview for complex data analysis as per model guidelines
      ...
      // Fixed: Extract text using .text property instead of method call or deep property access
