...
import { Info, Target, Calendar, ArrowUpRight, ArrowDownRight, Minus, TrendingUp, ChevronDown, Filter, X, MousePointerClick, Check } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800/40 border border-slate-700/50 rounded-2xl p-6">
           <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-semibold text-white">Distribuição por Categoria (Nível 5)</h3>
              <div className="flex items-center gap-1 text-[10px] text-slate-400 bg-slate-900/50 px-2 py-1 rounded border border-slate-800">
